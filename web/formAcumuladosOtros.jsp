...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<div class="row-fluid">
				<a class="brand span2" href="index.html"><span>CAISA</span></a>
				</div>		
				<!-- start: Header Menu -->
	...
	<!-- start: Header -->
			...
			<div id="sidebar-left" class="span2">
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Archivo</span> <span class="label">3</span></a>
							<ul>
								<li><a class="submenu" href="#"><i class="icon-hdd"></i><span class="hidden-tablet"> Cuentas Bancos</span></a></li>
								<li>
								<!--<a class="dropmenu" href="#"><i class="icon-hdd"></i><span class="hidden-tablet"> Empleados</span></a>-->
								<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Empleados</span> <span class="label">3</span></a>
									...
									<ul>
										...
										<li><a class="dropmenu" href="#" style="color: #FFFFFF"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Acumulados</span><span class="label">8</span></a>
										<ul>
								  ...
								  <label class="checkbox inline">
									...
									<fieldset>
										...
										<div class="control-group">
											...
											<div class="controls">
												<span class="input-xlarge uneditable-input">Åukasz Holeczek</span>
											</div>
										</div>
										<div class="control-group">
		...
		<footer>
			<p>
				<span style="text-align:left;float:left">&copy; 2013 <a href="#" alt="Bootstrap Themes">>CAISA S.A.</a></span>
				<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="#" alt="Bootstrap Admin Templates">Pao Systems</a></span>
			</p>
